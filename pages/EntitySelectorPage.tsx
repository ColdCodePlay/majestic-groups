    ...
    return (
        <div className="pt-20 min-h-screen bg-slate-50/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
                ...
                <div className="inline-flex items-center justify-center p-2 bg-emerald-100 rounded-xl mb-4">
                ...
                <p className="text-base text-slate-500 max-w-xl mx-auto mb-6 leading-relaxed">
